...
@pt.mark.parametrize(
    "coordinates, charges",
    [
        (np.array([[1.0,2.0,3.0],[2.0,1.0,3.0]]),np.array([1.0,1.0])),
        (np.array([[1.0,2.0,3.0],[2.0,1.0,3.0],[3.0,1.0,2.0]]),np.array([1.0,1.0,1.0])),
        (np.array([[1.0,2.0,3.0],[2.0,1.0,3.0],[3.0,1.0,2.0],[5.0,4.0,3.0]]),np.array([1.0,1.0,1.0,1.0])),
